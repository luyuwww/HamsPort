...
public class JdbcDaoImpl implements JdbcDao {
    ...
    public Integer insertEfile(String tableName, final EFile eFile) {
        return jdbcTemplate.update("insert into " + tableName +
                "(DID,PID,EFILENAME,TITLE,EXT,PZM,PATHNAME,STATUS,ATTR,ATTREX,CREATOR,CREATETIME,FILESIZE,MD5,CONVERTSTATUS,XLH,BBH,ESORT) "
            ...
            public void setValues(PreparedStatement ps) throws SQLException {
                ...
                ps.setString(i++, eFile.getXlh());
                ps.setString(i++, eFile.getBbh());
                ps.setInt(i++, eFile.getEsort());
            }
        });
    }
