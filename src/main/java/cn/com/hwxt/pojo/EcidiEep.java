 ...
 */
public class EcidiEep  implements Serializable {
    private static final long serialVersionUID = 206316155344141684L;
    ...
    private List<EcidiEepFileBlock> ecidiEepFileBlocks;//文件实体块
    ...
    public List<EcidiEepFileBlock> getEcidiEepFileBlocks() {
        return ecidiEepFileBlocks;
    }

    public void setEcidiEepFileBlocks(List<EcidiEepFileBlock> ecidiEepFileBlocks) {
        this.ecidiEepFileBlocks = ecidiEepFileBlocks;
    }
}
