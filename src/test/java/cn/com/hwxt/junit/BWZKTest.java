...
//		baseDataServiceImpl.updateUserByJson(sw.toString().toString(), "5555");
        ...
        // File("D:/HamsPort/target/classes/XML/S_USER.XML") , "UTF-8");
        // System.out.println(baseDataServiceImpl.AddUserByXml("S_USER.XML",
        // xml));
        // String xml = FileUtils.readFileToString(new
        // File("D:/HamsPort/target/classes/XML/D_FILE25.XML") , "UTF-8");
        ...
        // URL url = new URL("http://localhost/HamsPort/cxf/BaseDataWS?wsdl");
